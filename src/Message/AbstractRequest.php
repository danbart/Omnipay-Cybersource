...
use Omnipay\Cybersource\Constats;
use Omnipay\Common\Message\AbstractRequest as BaseAbstractRequest;

abstract class AbstractRequest extends BaseAbstractRequest
{
    protected $livEndpint = Constats::LIVE_ENDPOINT;
    protected $testEndpint = Constats::TEST_ENDPOINT;

    public function sendData($data)
    {

        return $this->response = new AbstractResponse($this, $data, $this->getEndpoint());
    }
     ...
     * @return string
     */
    public function generateDigest($body)
    {
        return base64_encode(hash("sha256", utf8_encode(json_encode($body)), true));
    }
}
